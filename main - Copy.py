...
Car_start_audio = mixer.music.load("car_start.wav")
...
def main():
    ...
    Obs9 = Obstacle(random.randint(SCREEN_LENGTH/5,SCREEN_LENGTH*3/5),random.randint(-110,-70),SCREEN_LENGTH, SCREEN_HEIGHT)
    ...
    obstacle_sprite_group.add(Obs9)
    ...
    ZigZagSpeed1 = 5 # for level 3
    ZigZagSpeed2 = 3 # for level 3
    ZigZagSpeed3 = 6 # for level 3
    global pause
    run = True
    while run:
        quit()
        ...
        if Distance >= 10 and Distance < 15:
            ...
            #Obs5.move(7)
            #Obs6.move(8)
            ZigZagSpeed1 = Obs7.slant_move(ZigZagSpeed1)
            #ZigZagSpeed2 = Obs8.slant_move(ZigZagSpeed2)
        ...
        if Distance >= 25:
            ...
            ZigZagSpeed1 = Obs7.slant_move(ZigZagSpeed1)
            ZigZagSpeed2 = Obs8.slant_move(ZigZagSpeed2)
            ZigZagSpeed3 = Obs9.slant_move(ZigZagSpeed3)
